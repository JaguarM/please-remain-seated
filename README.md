...
Two people could be in 9C, and the title boards you as either in one click. Dr Priya Ansel talks
people out of their seats and cannot lift the heavy ones. Gordy Mach carries two at a time and
nobody listens to him. That is the game's own fork, and the best runs do both.

There are no perks. Each has five numbers, one to ten, and every number is a multiplier on
something you feel inside a minute: strength (how long a carry takes, who can be carried at all,
and at ten, two at once), speed, lungs, nerve, voice. Both board with a water bottle, a phone and
a blanket. The other eleven things are in the aeroplane: two in the galley drawers, two in the
crew's kit, seven in other passengers' laps, so getting equipped is the same conversation as
recruiting.
...
---------------
    ...
    game/
      ...
      sim/                cabin geometry, fire, passengers, crew, the action engine, undo, scoring
...
the two characters, events, medals, endings), `game/sim/crew.js` and `game/sim/pax.js` (what the
