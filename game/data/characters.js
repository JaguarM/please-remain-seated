    ...
    const CHARACTERS = [
        {
            ...
            open: K("You have already worked out who on this aeroplane is going to die first."),
        },
        {
            ...
            open: K("Everything on this aeroplane is lighter than your opener."),
        },
        {
            id: "volk", name: "Deidre Volk", short: "Deidre", age: 71,
            title: K("Retired station officer"),
            ...
            unlock: { medal: "seen_it",
                      text: K("Open the overhead locker and look at what is actually in it.") },
            hair: "#dfe3e6", skin: "#e5b791", shirt: "#4f5a68",
            open: K("You have smelled this before. Nobody else on this aeroplane has."),
        },
        {
            ...
            unlock: { medal: "four_helpers", text: K("Recruit four helpers in one flight.") },
            hair: "#9aa0a6", longHair: true, skin: "#d9a279", shirt: "#232630",
            open: K("You have buried more people than anyone else on board. It has not helped."),
        },
        {
            ...
            unlock: { medal: "five_carry",
                      text: K("Carry five people to a galley yourself, in one flight.") },
            hair: "#d9b16a", skin: "#f2d0b4", shirt: "#2f3f7a",
            open: K("This is the single greatest thing that has ever happened to your channel."),
        },
        {
            ...
            unlock: { medal: "declared",
                      text: K("Get the flight deck to declare an emergency inside five minutes.") },
            hair: "#9aa0a6", skin: "#e5b791", shirt: "#1c2130",
            open: K("You have flown this approach nine hundred times. Never from row 22."),
        },
        {
            ...
            open: K("You have been watching seat 14C for an hour. For the wrong reasons."),
        },
        {
            ...
            unlock: { medal: "child_secured",
                      text: K("Get a child out of the rows and down on the floor by a door.") },
            hair: "#1d1712", longHair: true, skin: "#e5b791", shirt: "#b8617f",
            open: K("The lady said she would come back and check on you. That was a long time ago."),
        },
        {
            id: "beverley", name: "Beverley Crane", short: "Beverley", age: 66,
            title: K("Retired purser"),
            ...
            unlock: { medal: "twentytwo_souls",
                      text: K("Get fifty-two people off alive in one flight.") },
            hair: "#dfe3e6", longHair: true, skin: "#c08a5e", shirt: "#c9c0aa",
            open: K("You know where everything is. You know it will not be enough."),
        },
    ];
