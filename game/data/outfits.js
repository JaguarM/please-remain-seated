...
(function (global) {
    ...
    // own stats and the total is clamped to 1..10. `unlock` is the souls-secured total in the
    // log book at which it hangs in the wardrobe.
    const OUTFITS = [
        {
            id: "gym", name: "Gym kit and trainers", unlock: 10, sprite: "outfit_gym",
        ...
        {
            id: "suit", name: "The suit you flew in", unlock: 35, sprite: "outfit_suit",
        ...
        {
            id: "work", name: "Work clothes", unlock: 70, sprite: "outfit_work",
        ...
        {
            id: "comfort", name: "Dressed for a long flight", unlock: 115, sprite: "outfit_comfort",
        ...
        {
            id: "hill", name: "Straight off a hill", unlock: 170, sprite: "outfit_hill",
        ...
        {
            id: "beach", name: "Shorts and flip-flops", unlock: 240, sprite: "outfit_beach",
